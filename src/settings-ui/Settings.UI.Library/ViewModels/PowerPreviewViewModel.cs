...
namespace Microsoft.PowerToys.Settings.UI.Library.ViewModels
{
    public class PowerPreviewViewModel : Observable
    {
        ...
        public PowerPreviewViewModel(ISettingsRepository<PowerPreviewSettings> moduleSettingsRepository, ISettingsRepository<GeneralSettings> generalSettingsRepository, Func<string, int> ipcMSGCallBackFunc, string configFileSubfolder = "")
        {
            ...
            _folderRenderIsEnabled = Settings.Properties.EnableFolderPreview;
        }
        ...
        private bool _folderRenderIsEnabled;
        ...
        public bool FolderRenderIsEnabled
        {
            get
            {
                return _folderRenderIsEnabled;
            }

            set
            {
                if (value != _folderRenderIsEnabled)
                {
                    _folderRenderIsEnabled = value;
                    Settings.Properties.EnableFolderPreview = value;
                    RaisePropertyChanged();
                }
            }
        }
